...
namespace S3Train.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<JsonResult> CheckValidUser(LoginViewModel model)
        {
            string result = "Fail";
            var DataItem= await SignInManager.PasswordSignInAsync(model.Email, model.Password, model.RememberMe, shouldLockout: false);
